...
render() {
  ...
  return (
    ...
    <div className="button-container">
      <button onClick={(e) => this.handleButtonClick(e, 'generate')}>Generate New Array</button>
      <button onClick={(e) => this.handleButtonClick(e, 'merge')}>MERGE SORT</button>
      <button onClick={(e) => this.handleButtonClick(e, 'quick')}>QUICK SORT</button>
      <button onClick={(e) => this.handleButtonClick(e, 'heap')}>HEAP SORT</button>
      <button onClick={(e) => this.handleButtonClick(e, 'stop')}>Stop Sorting</button>
      <button onClick={(e) => this.handleButtonClick(e, 'continue')}>Continue</button>
      <button onClick={(e) => this.handleButtonClick(e, 'resetSort')}>Reset</button>
